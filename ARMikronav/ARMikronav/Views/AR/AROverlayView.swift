...
// ARMikronav
//
// SwiftUI-Overlay über der ARView (Wireframe 3.1): runde Mini-Karte unten
// links, "Zur Karte"-Pill unten rechts. Wird von ARModeView zusammen mit
// ARViewContainer in einem ZStack gerendert.
