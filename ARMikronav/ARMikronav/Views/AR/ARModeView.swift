...
// ARMikronav
//
// Vollbild-AR-Ansicht (Wireframes 3.1/3.1a/3.1b/3.1c).
...
struct ARModeView: View {
    ...
    private var arContent: some View {
        ZStack(alignment: .top) {
            ...
            // Coaching-Overlay (3.1a), solange die Session startet
            if case .starting = arService.sessionState {
                coachingOverlay
            }
        }
...
// MARK: - POI-Karte im AR-Raum (3.1b)
